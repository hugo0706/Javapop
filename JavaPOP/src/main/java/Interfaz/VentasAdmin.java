...
public class VentasAdmin extends javax.swing.JFrame {
    ...
    public void mostrarProductos(){
        ...
        for(Venta p:ventasGlobales){
            productos.addElement(p.getTitulo()+" Precio: "+p.getPrecio());
            
        }
        ListaVentas.setModel((ListModel<String>)productos);
    }
    ...
    private void ListaVentasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ListaVentasMouseClicked
        ...
        vendedor.setText((titulo.getVendedor()).getCorreo());
        comprador.setText((titulo.getComprador()).getCorreo());
